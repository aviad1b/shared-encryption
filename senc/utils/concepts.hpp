...
#ifdef SENC_MSVC
#define SENC_REQ_NOEXCEPT(...) SENC_EXPAND(GET_MACRO(__VA_ARGS__, SENC_REQ_NOEXCEPT_10, SENC_REQ_NOEXCEPT_9, SENC_REQ_NOEXCEPT_8, SENC_REQ_NOEXCEPT_7, SENC_REQ_NOEXCEPT_6, SENC_REQ_NOEXCEPT_5, SENC_REQ_NOEXCEPT_4, SENC_REQ_NOEXCEPT_3, SENC_REQ_NOEXCEPT_2, SENC_REQ_NOEXCEPT_1)(__VA_ARGS__))
#else
...
#ifdef SENC_MSVC
#define SENC_REQ(...) SENC_EXPAND(GET_MACRO(__VA_ARGS__, SENC_REQ_10, SENC_REQ_9, SENC_REQ_8, SENC_REQ_7, SENC_REQ_6, SENC_REQ_5, SENC_REQ_4, SENC_REQ_3, SENC_REQ_2, SENC_REQ_1)(__VA_ARGS__))
#else
...
#ifdef SENC_MSVC
#define SENC_REQ_NOEXCEPT_COND(cond, ...) SENC_EXPAND(GET_MACRO(__VA_ARGS__, SENC_REQ_NOEXCEPT_COND_10, SENC_REQ_NOEXCEPT_COND_9, SENC_REQ_NOEXCEPT_COND_8, SENC_REQ_NOEXCEPT_COND_7, SENC_REQ_NOEXCEPT_COND_6, SENC_REQ_NOEXCEPT_COND_5, SENC_REQ_NOEXCEPT_COND_4, SENC_REQ_NOEXCEPT_COND_3, SENC_REQ_NOEXCEPT_COND_2, SENC_REQ_NOEXCEPT_COND_1)(cond, __VA_ARGS__))
#else
